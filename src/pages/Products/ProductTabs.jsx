              ...
              <form onSubmit={submitHandler} className="max-w-2xl">
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent bg-white text-gray-900 font-medium resize-none"
                  />
          ...
          <div>
            {!data ? (
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center">
                <FaBox className="mx-auto text-blue-600 mb-4" size={40} />
